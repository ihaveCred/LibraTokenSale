...
module.exports = function (deployer) {
    deployer.deploy(LibraToken)
        ...
        .then(function () {
            ...
            return deployer.deploy(LibraTokenSale, 10000, "0x627306090abaB3A6e1400e9345bC60c78a8BEf57", LibraToken.address, 1525132800, 1525132800 + 1209600, 1525132800 + 1209600*2);
    });
};
